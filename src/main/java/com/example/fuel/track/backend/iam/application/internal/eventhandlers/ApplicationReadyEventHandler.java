package com.example.fuel.track.backend.iam.application.internal.eventhandlers;

import com.example.fuel.track.backend.iam.domain.model.commands.SeedRolesCommand;
import com.example.fuel.track.backend.iam.domain.services.RoleCommandService;
