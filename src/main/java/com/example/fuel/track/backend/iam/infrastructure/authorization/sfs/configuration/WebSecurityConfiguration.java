package com.example.fuel.track.backend.iam.infrastructure.authorization.sfs.configuration;

import com.example.fuel.track.backend.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.example.fuel.track.backend.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.example.fuel.track.backend.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(configurer -> configurer.configurationSource(request -> {
            ...
            cors.setAllowedOrigins(List.of("http://localhost:4200", "https://fueltrack-frontend.vercel.app"));
