package com.example.fuel.track.backend.iam.infrastructure.persistence.jpa.repositories;
...
public interface UserRepository extends JpaRepository<User, Long>
{
    ...
    /**
     * This method is responsible for checking if the user exists by DNI.
     * @param dni
     * @return
     */
